        ...
        <div className='p-4 flex flex-col justify-around'>
          <form>
            ...
            <div className='mt-6 text-right'>
              <button className='font-medium text-base text-violet-700'><Link href="/forgot-password">
            ...
            <div className='mt-6 flex justify-center items-center'>
              ...
              <button className='text-violet-700 text-base font-medium ml-2'><Link href="/register">
                Register</Link>
              </button>
            </div>
          </form>
